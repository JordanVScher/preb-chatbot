...
it('Follow up - user estava no quiz publico_interesse, perguntamos se quer voltar', async () => {
	const context = cont.textContext('oi, isso é um teste', 'test');
...
it('Follow up - user estava no quiz brincadeira, perguntamos se quer voltar', async () => {
	const context = cont.textContext('oi, isso é um teste', 'test');
...
it('Follow up - user estava no quiz recrutamento, perguntamos se quer voltar', async () => {
	const context = cont.textContext('oi, isso é um teste', 'test');
...
it('Follow up - user não acabou publico_interesse, perguntamos se quer terminar (menos de 3 vezes)', async () => {
	const context = cont.textContext('oi, isso é um teste', 'test');
...
it('Follow up - user não é publico_interesse e não acabou brincadeira, perguntamos se quer terminar (menos de 3 vezes)', async () => {
	const context = cont.textContext('oi, isso é um teste', 'test');
...
it('Follow up - user é publico_interesse, já marcou consulta mas não acabou recrutamento, perguntamos se quer terminar (menos de 3)', async () => {
	const context = cont.textContext('oi, isso é um teste', 'test');
	context.state.categoryQuestion = 'recrutamento'; context.state.goBackToQuiz = false; context.state.startedQuiz = true;
	context.state.user = { is_target_audience: 1 }; context.state.currentCounter = { count_quiz: 0 };
	...
	await expect(!context.state.recrutamentoEnd).toBeTruthy();
...
it('Follow up - user é publico_interesse, deixou contato mas não acabou recrutamento, perguntamos mais de 3 vezes, vai pro menu', async () => {
	const context = cont.textContext('oi, isso é um teste', 'test');
	context.state.categoryQuestion = 'recrutamento'; context.state.goBackToQuiz = false; context.state.startedQuiz = true;
	context.state.user = { is_target_audience: 1 }; context.state.currentCounter = { count_quiz: 3 };
