module.exports = {
	...
	join: {
		...
		joinCombina: {
			text1: 'O Projeto Combina faz parte de uma pesquisa que avalia o uso dos métodos de prevenção ao HIV disponíveis nos serviços públicos de saúde. Saber as motivações e em quais situações são usados esses métodos tbm é super importante! Esse projeto é tudo de bom!',
...
OBS: Chá de erva- doce pode ajudar!`,
		...
		drpIST: {
			...
			drpBolhas: 'Podem ser herpes, se forem feridas q formigam e coçam tbm. Podem aparecer na boca, pinto, cu ou outras partes do corpo. É legal ñ tocar, lavar bem as mãos e se for na boca, evitar compartilhar talheres, batons, copos.. Bjo e oral só dps de cicatrizar!',
