module.exports = {
	...
	deuRuimNaoPrep: {
		...
		drnpPEPNao: {
			...
			drnpNaoSentiBem: 'No geral, pode rolar náuseas, diarreia, dor de cabeça e moleza no corpo. Se tiver insônia troque o horário de tomar pra de manhã. Tbm pode ocorrer icterícia q são olhos amarelos, isso ñ significa problemas no fígado (hepatite), é genético e depende de cada pessoa ou do dia.\nSe vc ñ parou de usar, continue usando e podemos marcar uma consulta pra falar melhor disso, bee!',
			drnpPerdi: 'Bora marcar uma consulta no serviço pra ver oq rolou e a gente conseguir te ajudar a continuar sem dar ruim? Assim é melhor pra entender teu caso!',
